if (!(build in window)) {
	window.build = function(tag_name, class_name, parent, inner_html) {
	...
	window.random_string = function(n) {
		n = n || 10;
	...
	window.h5p_get_data_obj = function(s) {
	...
	window.h5p_get_data_str = function(o) {
		return h5p_get_data_str_v1(o);
	}

	window.h5p_get_data_obj_v1 = function(s) {
		return JSON.parse(atob(s.substring(3)));
	}

	window.h5p_get_data_str_v1 = function(o) {
	...
	window.h5p_get_data_obj_v0 = function(s) {
	...
	window.h5p_get_data_str_v0 = function(o) {
		if (o === undefined) return undefined;
